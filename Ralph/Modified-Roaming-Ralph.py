...
class World(DirectObject):
    ...
    def __init__(self):
        ...
        self.Health = DirectWaitBar(text = "", value = 100,  barColor= (1,0,0,1), frameSize = (-1,1,.3,.5),scale = 2)
    ...
    def setupHealthBar(self):
        self.hpBar = DirectWaitBar( text = "", value = 100.0, pos = (0, 0, 1.5), scale = 3, barColor = Vec4(1, 0, 0, 1) )
